...
public class ListTasks extends AppCompatActivity {
    ...
    private void showData(DataSnapshot dataSnapshot) {
        for(DataSnapshot ds : dataSnapshot.getChildren()){
            ...
            uInfo.setPass(ds.child(userID).getValue(User.class).getPass()); //set the pass
            uInfo.setPhone(ds.child(userID).getValue(User.class).getPhone());//set the phone
            //display all the information
            Log.d(TAG, "showData: name: " + uInfo.getName());
            Log.d(TAG, "showData: email: " + uInfo.getEmail());
            Log.d(TAG, "showData: phone: " + uInfo.getPhone());
            Log.d(TAG, "showData: pass: " + uInfo.getPass());
